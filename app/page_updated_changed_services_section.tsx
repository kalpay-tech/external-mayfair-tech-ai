  ...
  const services = [
    {
      ...
      link: "/solutions/ai",
      color: "#6fee51", // Green parrot color
      icon: (
    ...
    },
    {
      ...
      image: "/images/services/e-business.jpg",
      link: "/solutions/e-business",
      color: "#31703a", // Dark green
      icon: (
        <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-12">
            ...
            <div className="space-y-3">
              {services.map((service, index) => (
                <button
                  ...
                  className={`w-full rounded-xl border px-6 py-4 text-left transition-all duration-300 cursor-pointer ${
                    activeTab === index
                      ? "border-transparent text-white shadow-lg"
                      : "border-gray-200 bg-gray-50 text-[#081b3e] hover:border-gray-300 hover:bg-gray-100"
                  }`}
                  style={activeTab === index ? { backgroundColor: service.color, boxShadow: `0 10px 25px -5px ${service.color}20` } : {}}
                >
                  <div className="flex items-center gap-4">
                    {/* Icon */}
                    <div className={`flex-shrink-0 ${activeTab === index ? "text-white" : "text-[#081b3e]"}`}>
                      {service.icon}
                    </div>
                    
                    {/* Content */}
                    <div className="flex-1">
                      <h3 className={`text-base font-semibold ${activeTab === index ? "text-white" : "text-[#081b3e]"}`}>{service.title}</h3>
                      <p className={`mt-1 text-xs ${activeTab === index ? "text-white/80" : "text-[#707e8a]"}`}>
                        {service.features.length} services included
                      </p>
                    </div>
                    
                    {/* Arrow */}
                    <div className={`flex-shrink-0 transition-transform duration-300 ${
                      activeTab === index ? "text-white" : "text-[#707e8a]"
                    }`}>
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-8">
            <div 
              className="relative overflow-hidden rounded-3xl bg-white border-2 p-6 shadow-xl transition-all duration-500 sm:p-8"
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-semibold text-white">{activeService.title}</span>
              </div>

              {/* Image at Top - Horizontal */}
              <div className="mb-6 relative h-48 w-full overflow-hidden rounded-2xl bg-gray-100">
                {!imageError[activeTab] ? (
                  <Image
                    ...
                    onError={() => setImageError((prev) => ({ ...prev, [activeTab]: true }))}
                  />
                ) : (
                  <div className="absolute inset-0 flex items-center justify-center bg-gray-200">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="text-sm">{activeService.title}</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              {/* Description */}
              <p className="mb-6 text-sm leading-relaxed text-[#707e8a] sm:text-base">
              ...
              <div className="flex flex-wrap gap-4">
                {/* <Link
                  ...
                  style={{ 
                    ...
                    boxShadow: `0 10px 25px -5px ${activeService.color}40`
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = `0 15px 35px -5px ${activeService.color}50`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = `0 10px 25px -5px ${activeService.color}40`;
                  }}
                >
                  Get Started
                  <svg
                ...
                {/* <Link
                  href={activeService.link}
                  className="inline-flex items-center rounded-full border-2 px-8 py-4 text-base font-semibold transition-all duration-300 hover:bg-gray-50"
                  style={{ 
...
function SuccessStories() {
  const stories = [
    ...
    },
    {
      ...
      image: "/images/success-stories/SupplyChain.png",
      caseStudyLink: "/insights/case-studies",
    },
    {
      ...
      image: "/images/success-stories/logistics.png",
      caseStudyLink: "/insights/case-studies",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative h-[600px] w-full overflow-hidden rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100 shadow-2xl">
              <Image
                src="/images/products/mayfair-highstreet.jpg"
  ...
  const processSteps = [
    {
      ...
      imgSrc: "/images/our-process/step1.jpg",
    },
    {
      number: "02",
      title: "Design",
